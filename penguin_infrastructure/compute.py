...
def create_user_data(self):
    ...
    self.user_data.add_commands(
        f"cd penguin && sudo python3 -m pip install -r requirements.txt && sudo python3 -m bot.penguin --bot 1 --discord {self.DISCORD_TOKEN} --guild {self.GUILD_NAME} --acount {self.AWS_ACCOUNT_DSWD}"
    )
